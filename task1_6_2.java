    ...
    public static <k> void main(String[] args) {
        ...
        for (Laptop laptop : shop) {
            ...
            for (Integer key : request.keySet()) {
                ...
                switch (key) {
                    case (1):
                        if (laptop.nameLaptop.equalsIgnoreCase(request.get(1))) {
                            count++;
                        }
                        break;
                    case (2):
                        ...
                        break;
                    case (3):
                        if (laptop.ram >= Integer.parseInt(request.get(3))) {
                            count++;
                        }
                        break;
                    case (4):
                        if (laptop.rom >= Integer.parseInt(request.get(4))) {
                            count++;
                        }
                        break;
                    case (5):
                        if (laptop.nameCpu.equalsIgnoreCase(request.get(5))) {
                            count++;
                        }
                        break;
                    case (6):
                        if (laptop.nameOs.equalsIgnoreCase(request.get(6))) {
                            count++;
                        }
                        break;
                    case (7):
                        if (laptop.touchScreen == Boolean.parseBoolean(request.get(7))) {
                            count++;
                        }
                        break;
                    case (8):
                        if (laptop.opticalDrive == Boolean.parseBoolean(request.get(8))) {
                            count++;
                        }
                        break;
        ...
        while (exit != 0) {
            ...
            switch (exit) {
                ...
                case (2):
                    ...
                    break;
                case (3):
                    System.out.println("Введите минимальный размер оперативной памяти в Гб");
                    parameter = scanner.nextLine();
                    request.put(exit, parameter);
                    break;
                case (4):
                    System.out.println("Введите минимальный размер постоянной памяти в Гб");
                    parameter = scanner.nextLine();
                    request.put(exit, parameter);
                    break;
                case (5):
